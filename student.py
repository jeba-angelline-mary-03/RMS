...
class studentClass:
    def __init__(self, root):
        ...
        self.txt_pin.place(x=570, y=220, width=100)
        ...
        # Buttons
        self.btn_add = Button(self.root, text='Save', font=("goudy old style", 15, "bold"), bg="#219f63", fg="white", cursor="hand2", command=self.add)
