...
class RMS:
    def __init__(self,root):
        ...
        self.lbl_course=Label(self.root,text="Total Courses\n[0]",font=("gaudy old style",20),bd=10,relief=RIDGE,bg="#e43b06",fg="white")
        self.lbl_course.place(x=400,y=530,width=300,height=100)

        self.lbl_course=Label(self.root,text="Total Courses\n[0]",font=("gaudy old style",20),bd=10,relief=RIDGE,bg="#0676ad",fg="white")
        self.lbl_course.place(x=710,y=530,width=300,height=100) 

        self.lbl_course=Label(self.root,text="Total Results\n[0]",font=("gaudy old style",20),bd=10,relief=RIDGE,bg="#038074",fg="white")
        self.lbl_course.place(x=1020,y=530,width=300,height=100)
        footer=Label(self.root,text="SRMS-Student Result Management System\nContact Us For Any Technical Issue\n Issue:63xxxxxx60",font=("goudy old style",15),bg="#262626",fg="white").pack(side=BOTTOM,fill=X)
