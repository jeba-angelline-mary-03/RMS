...
class reportClass:
    def __init__(self, root):
        ...
        title = Label(self.root, text="View Students Results", font=("goudy old style", 20, "bold"), bg="orange", fg="#262626").place(x=10, y=15, width=1180, height=35)
        ...
        self.btn_search = Button(self.root, text='Search', font=("goudy old style", 15, "bold"), bg="#03a954", fg="white", cursor="hand2", command=self.search)
        self.btn_search.place(x=680, y=100, width=100, height=35)

        self.btn_clear = Button(self.root, text='Clear', font=("goudy old style", 15, "bold"), bg="gray", fg="white", cursor="hand2", command=self.clear)
        self.btn_clear.place(x=800, y=100, width=100, height=35)
